...
//       }
//     } catch (error) {
//       Alert.alert('Unable to Open Email', 'Something went wrong while trying to open the email app.');
//     }
//   };

//   return (
//     <LinearGradient
//       colors={['rgba(20,20,22,0.97)', 'rgba(20,20,22,0.90)']}
//       style={styles.footer}
//     >
...
//           <Pressable onPress={() => safeNavigate('BusinessApps')} style={footerLinkPressStyle}>
//             <Text style={styles.footerLink}>Business Apps</Text>
//           </Pressable>

//           <Pressable onPress={() => safeNavigate('CommerceSolutions')} style={footerLinkPressStyle}>
//             <Text style={styles.footerLink}>Commerce Solutions</Text>
//           </Pressable>

//           <Pressable onPress={() => safeNavigate('ManagementPlatforms')} style={footerLinkPressStyle}>
