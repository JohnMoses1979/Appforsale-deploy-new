...
// import { View, Text, Pressable, StyleSheet, Image, Platform, SafeAreaView, StatusBar, Dimensions } from 'react-native';
...
//   const fontScale = width / 375; // Base scale based on 375px screen width (iPhone 6)

//   return (
//     <SafeAreaView style={{ flex: 0 }}>
//       <LinearGradient
//         colors={['rgba(20,20,22,0.92)', 'rgba(20,20,22,0.82)']}
//         style={[styles.topBar, { paddingTop: statusBarHeight + (Platform.OS === 'ios' ? 5 : 10) }]} // Adjusted padding for iOS
//       >
...
//             >
//               <Text style={[styles.sideButtonText, { fontSize: 12 * fontScale }]}>Back</Text>
//             </Pressable>
//           ) : null}
...
//                 <Image
//                   source={COMPANY_LOGO}
//                   style={[styles.companyLogo, { width: 40 * fontScale, height: 40 * fontScale }]} // Resizing logo
//                   resizeMode="contain"
//                 />
//               </View>
//             ) : null}
...
//               {!!subtitle && <Text style={[styles.subtitle, { fontSize: 10 * fontScale }]}>{subtitle}</Text>}
//             </View>
//           </View>
//         </View>
...
//               >
//                 <Text style={[styles.iconButtonText, { fontSize: 16 * fontScale }]}>🔔</Text>
...
//               >
//                 <Text style={[styles.profileButtonText, { fontSize: 16 * fontScale }]}>{profileLabel}</Text>
//               </Pressable>
//             ) : null}
...
//                 style={({ pressed }) => [styles.sideButton, pressed && styles.pressed]}
//               >
//                 <Text style={[styles.sideButtonText, { fontSize: 12 * fontScale }]}>{rightLabel}</Text>
//               </Pressable>
//             ) : null}
//           </View>
//         ) : null}
...
//   topBar: {
//     minHeight: 90,  // Adjusted min height for iOS, can be higher for Android
//     borderRadius: 18,
//     borderWidth: 1,
...
// //   // Scale font sizes based on screen width (responsive font scaling)
// //   const fontScale = width / 375; // Base scale based on 375px screen width (iPhone 6)
...
// //       <LinearGradient
// //         colors={['rgba(20,20,22,0.92)', 'rgba(20,20,22,0.82)']}
// //         style={[styles.topBar, { paddingTop: statusBarHeight + 10 }]} // Adjusted padding for status bar height
// //       >
// //         <View style={styles.leftSection}>
// //           {showBack ? (
// //             <Pressable
...
// //   topBar: {
// //     minHeight: 100,  // Ensure enough height for visibility
// //     borderRadius: 18,
// //     borderWidth: 1,
// //     borderColor: 'rgba(255,255,255,0.08)',
// //     paddingHorizontal: 14,
